<template>
  <div class="list-page">
    <el-row>
      <el-col :span="6">{{ 'currencyManage' | t }}</el-col>
    </el-row>
    ...
    schema: function () {
      return initSchema({
        ...
        columns: {
          ...
          currencySymbo: {
            header: 'currencySymbo', getter: get('currencySymbo'), sortRank: 1,
            listSetter: identity,
            dataName: 'currencySymbo', defaultData: '',
          },
          description: {
